...
class DashboardFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        remoteConfig = Firebase.remoteConfig // Fixed initialization
        ...
        // Setup Buttons - Ensure these IDs match your XML exactly
    ...
    private fun loadNativeAd(view: View) {
        val adLoader = AdLoader.Builder(requireContext(), "ca-app-pub-3940256099942544/2247696110") // Test ID
            .forNativeAd { nativeAd ->
                ...
                // Map your Native Ad Views here (headline, body, etc.)
